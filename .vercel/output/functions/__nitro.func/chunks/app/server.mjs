import { getCurrentInstance, version, shallowRef, computed, reactive, isReadonly, useSSRContext, createApp, toRef, isRef, nextTick, provide, onErrorCaptured, onServerPrefetch, unref, inject, defineAsyncComponent, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/detail-94799639.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5689abd7.mjs').then((m) => m.default || m)
  }
];
